                                                ...
                                                <div class="row">
                                                    <div class="col-lg-12">
                                                        <div class="floating-label form-group">
                                                            <input id="name" class="floating-input form-control" name="name" type="text" placeholder=" ">
                                                    ...
                                                    <div class="col-lg-12">
                                                        <div class="floating-label form-group">
                                                            <input id="password-confirm" name="password_confirmation" class="floating-input form-control" type="password" placeholder=" ">
                                                            <label>Confirm Password</label>
                                                        </div>
                                                    </div>

                                                </div>
                                                <button type="submit" class="btn btn-white btn-lg">Sign Up</button>
                                                <p class="mt-3">
